...
R:  .space 20 # Espaço para resultado (3, 0x7fffffff, 0x80000000, 0, 0x80000000)
...
iter:beq  a3, zero, fim    
     lw   t0, (a0)   
     lw   t1, (a1)
     add  t2, t0, t1     # Se sign(t0)=sign(t1) e sign(t2)!= sign(t0) há OVF
     sw   a0, 16(sp)
     sw   a1, 12(sp)
     sw   a2, 8(sp)
     sw   a3, 4(sp)
     ...
     bgt  t2, zero, OVFneg
     li   t2, 0x7fffffff # Satura no número "mais positivo"
     j    notOVF         # Prossegue
OVFneg:
